...
export const insertVisitSchema = createInsertSchema(visits, {
  ...
  booksSubmitted: z.array(z.string()).min(1, "Please select at least one book").optional().nullable(),
  products: z.array(z.string()).min(1, "Please select at least one product").optional().nullable(),
